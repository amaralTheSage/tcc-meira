                                    ...
                                    <li className="cursor-pointer">
                                        {editingId === page.id ? (
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    'group :text-white flex w-full cursor-pointer items-center gap-2 px-2 py-1.5 text-sm text-muted-foreground transition-colors hover:text-white',
                                                    activePage === page.id && 'border-l-8 text-white',
                                                )}
                                            >
