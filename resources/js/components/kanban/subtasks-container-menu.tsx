...
export default function SubtaskContainerMenu({ subtask, project_id }: { subtask: TaskSubtask; project_id: string }) {
    ...
    return (
        <div className="relative mb-0.5 flex items-center gap-2 border-y border-border/70 pl-4">
            <input
                className="h-5 w-5 cursor-pointer appearance-none rounded-full border-2 border-solid border-red-800 bg-transparent checked:bg-red-700"
                type="checkbox"
            ...
            <div className="flex min-h-5 w-full max-w-11/12 items-center rounded-md p-1.5 duration-75">
                <div className="flex w-full items-center justify-between pl-2">
                    ...
                    <i
                        className="fa-solid fa-ellipsis-vertical fa-lg cursor-pointer hover:text-red-300"
                        onClick={(e) => {
                            e.stopPropagation();
