...
export default function Traceboard({ project }: { project: Project }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs} project={project}>
            ...
            <div className="flex h-14 shrink-0 items-center justify-end border-b border-border/70 bg-background px-6">
                <Select value={selectedSprint} onValueChange={setSelectedSprint}>
                    <SelectTrigger
                        data-testid="traceboard-sprint-filter"
                        className="w-40 cursor-pointer border-border/70 bg-sidebar/50 text-white shadow-none"
                    >
