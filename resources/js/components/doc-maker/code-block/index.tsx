...
export const CodeBlock = ({
    ...
    return (
        <CodeBlockContext.Provider value={{ value, onValueChange, data }}>
            <div className={cn('size-full overflow-hidden rounded-md border', className)} {...(props as any)} />
...
export const CodeBlockHeader = ({ className, ...props }: CodeBlockHeaderProps) => (
    <div className={cn('flex flex-row items-center border-b bg-secondary p-1', className)} {...(props as any)} />
);
...
export const CodeBlockFilename = ({ className, icon, value, children, ...props }: CodeBlockFilenameProps) => {
    ...
    return (
        <div className="flex items-center gap-2 bg-secondary px-4 py-1.5 text-xs text-muted-foreground" {...(props as any)}>
...
export const CodeBlockSelectTrigger = ({ className, ...props }: CodeBlockSelectTriggerProps) => (
    <SelectTrigger className={cn('w-fit border-none text-xs text-muted-foreground shadow-none', className)} {...(props as any)} />
);

export type CodeBlockSelectValueProps = ComponentProps<typeof SelectValue>;

export const CodeBlockSelectValue = (props: CodeBlockSelectValueProps) => <SelectValue {...(props as any)} />;
...
export const CodeBlockCopyButton = ({ asChild, onCopy, onError, timeout = 2000, children, className, ...props }: CodeBlockCopyButtonProps) => {
    ...
    return (
        <Button className={cn('shrink-0', className)} onClick={copyToClipboard} size="icon" variant="ghost" {...(props as any)}>
